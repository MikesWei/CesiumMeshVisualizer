...
varying float v_distanceDeg; 
varying float v_totalDistance; 
varying float v_distancePercent; 
varying float v_distancePx; 

void main(){
    v_featureId=featureId;
    v_sideMask= sideMask;
    v_distanceDeg=distanceToStart;
    v_totalDistance=totalDistance;
    v_distancePercent=distanceToStart/totalDistance;
