THREE.Ocean = function ( renderer, camera, scene, options ) {
	...
	var screenQuadGeometry = new THREE.PlaneBufferGeometry(2, 2);
	...
	this.pingTransformFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialOceanHorizontal)); // new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
	this.pongTransformFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialOceanHorizontal)); //new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
	scene.updateFrameBufferTexture(scene.frameState, this.pingTransformFramebuffer);
	scene.updateFrameBufferTexture(scene.frameState, this.pongTransformFramebuffer);
	...
	this.displacementMapFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialOceanVertical)); //new THREE.WebGLRenderTarget(this.resolution, this.resolution, LinearClampParams);
	scene.updateFrameBufferTexture(scene.frameState, this.displacementMapFramebuffer);
	...
	this.initialSpectrumFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialInitialSpectrum));//new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestRepeatParams);
	//scene.updateFrameBufferTexture(scene.frameState, this.initialSpectrumFramebuffer);
	...
	this.pingPhaseFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialPhase)); // new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
	this.pongPhaseFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialPhase)); //new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
	//scene.updateFrameBufferTexture(scene.frameState, this.pingPhaseFramebuffer);
	//scene.updateFrameBufferTexture(scene.frameState, this.pongPhaseFramebuffer);
	...
	this.spectrumFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialSpectrum)); //new THREE.WebGLRenderTarget(this.resolution, this.resolution, NearestClampParams);
	//scene.updateFrameBufferTexture(scene.frameState, this.spectrumFramebuffer);
	...
	this.normalMapFramebuffer = new FramebufferTexture(new THREE.Mesh(screenQuadGeometry, this.materialNormal)); //new THREE.WebGLRenderTarget(this.resolution, this.resolution, LinearClampParams);
	//scene.updateFrameBufferTexture(scene.frameState, this.normalMapFramebuffer);
...
THREE.Ocean.prototype.renderInitialSpectrum = function () {
	...
	this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.initialSpectrumFramebuffer);
...
THREE.Ocean.prototype.renderWavePhase = function () {
	...
	this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.pingPhase ? this.pongPhaseFramebuffer : this.pingPhaseFramebuffer);
...
THREE.Ocean.prototype.renderSpectrum = function () {
	...
	this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.spectrumFramebuffer);
...
THREE.Ocean.prototype.renderSpectrumFFT = function() {
	...
	for ( var i = 0; i < iterations; i ++ ) {
		...
		if ( i === 0 ) {
			...
			this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.pingTransformFramebuffer);
			...
			this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.pongTransformFramebuffer);
	...
	for ( var i = iterations; i < iterations * 2; i ++ ) {
		...
		if ( i === iterations * 2 - 1 ) {
			...
			this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.displacementMapFramebuffer);
...
//this.scene.overrideMaterial = this.materialNormal;
	...
	this.msScene.updateFrameBufferTexture(this.msScene.frameState, this.normalMapFramebuffer);
};
